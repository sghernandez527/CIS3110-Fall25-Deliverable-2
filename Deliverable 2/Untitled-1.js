        ...
        Papa.parse(filePath, {
            ...
            complete: function(results) {
                if (results.data && results.data.length > 0) {
                    // Filter out any completely empty rows that PapaParse might include
...
async function loadAllData() {
    console.log("Dashboard Initiated. Attempting to load 5 datasets...");
    ...
    try {
        ...
        console.log("SUCCESS: All 5 datasets loaded and parsed.");
        ...
        console.error("FAILED: Dashboard data loading failed.", error);
        document.querySelector('.container-fluid').innerHTML = 
            '<div class="alert alert-danger" role="alert">Error loading dashboard data. Check console for details. Ensure CSV files are present.</div>';
    }
}
